...
[![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![Tools](https://img.shields.io/badge/tools-2743-blue)](https://thirtysix.github.io/awesome-regulatory-genomics/) [![License: CC BY 4.0](https://img.shields.io/badge/data-CC--BY--4.0-lightgrey)](LICENSE-DATA) [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.21755613.svg)](https://doi.org/10.5281/zenodo.21755613) [![Updated](https://img.shields.io/badge/updated-2026--09--03-brightgreen)](#)
...
**[Browse and search all 2743 tools →](https://thirtysix.github.io/awesome-regulatory-genomics/)**. Filter by category, tool type, language, repository activity, and per column by name, description, links, package availability, stars, citations and year. The panel above the table charts publication year, repository activity, citations and stars **for whatever is currently filtered**, so "when were the peak callers written, and are they still maintained" is one click rather than a download.

Most curated lists are typed once and drift. This one is **generated by a reproducible pipeline and then curated by hand**, and it is rebuilt on a schedule rather than when someone remembers. Three things follow from that, and they are the reason to prefer it:

- **Every citation count is verified, not inherited.** A publication that resolves can still be the wrong paper, so each one is checked against the tool it claims to describe. Where several tools share a platform paper, no count is shown rather than crediting each of them with the platform's total.
- **The boundary is arguable.** Records that were considered and excluded are published with the reason, in [`data/excluded.tsv`](data/excluded.tsv) and [`docs/scope-audit.md`](docs/scope-audit.md), so you can disagree with a judgement instead of wondering whether a tool was missed or rejected.
- **You can rebuild it.** `make curate` reproduces the catalog from committed data with no network and no API key; `make all` re-harvests from scratch. See [How this list is built](#how-this-list-is-built).

It builds on [bio.tools](https://bio.tools), the ELIXIR registry, which is what makes a catalog this size possible at all. A hand-written overlay adds tools the registry does not index, and corrections found while building this list are fed back upstream.

## Contents

- [Motif discovery](#motif-discovery), 245 tools
- [Motif scanning & enrichment](#motif-scanning--enrichment), 212 tools
- [Motif comparison & visualisation](#motif-comparison--visualisation), 41 tools
- [Motif & TF databases](#motif--tf-databases), 112 tools
- [TFBS prediction](#tfbs-prediction), 672 tools
- [Promoter & enhancer prediction](#promoter--enhancer-prediction), 550 tools
- [Reporter assays](#reporter-assays), 11 tools
- [Footprinting](#footprinting), 57 tools
- [Peak calling](#peak-calling), 567 tools
- [Peak annotation & differential binding](#peak-annotation--differential-binding), 132 tools
- [ChIP/ATAC data resources](#chipatac-data-resources), 151 tools
- [Gene regulatory networks](#gene-regulatory-networks), 519 tools
- [Regulatory variant effect](#regulatory-variant-effect), 137 tools
- [Molecular QTL](#molecular-qtl), 107 tools
- [Nucleosome & chromatin state](#nucleosome--chromatin-state), 575 tools
- [Histone modifications](#histone-modifications), 54 tools
- [3D genome & chromatin interactions](#3d-genome--chromatin-interactions), 224 tools
- [DNA methylation](#dna-methylation), 393 tools
- [Single-cell regulatory genomics](#single-cell-regulatory-genomics), 230 tools
- [Comparative & evolutionary](#comparative--evolutionary), 50 tools
...
<sub>[+ 240 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-discovery)</sub>
...
<sub>[+ 40 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-comparison)</sub>
...
<sub>[+ 106 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-databases)</sub>
...
<sub>[+ 663 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=tfbs-prediction)</sub>
...
<sub>[+ 546 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=regulatory-elements)</sub>

## Reporter assays

*MPRA, STARR-seq and other massively parallel tests of regulatory activity.*

<sub>[11 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=reporter-assays)</sub>
...
<sub>[+ 55 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=footprinting)</sub>
...
<sub>[+ 563 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-calling)</sub>

## Peak annotation & differential binding

*Annotating peaks to genes/features and testing differential occupancy.*

<sub>[132 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-annotation)</sub>
...
<sub>[+ 148 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=chip-resources)</sub>
...
<sub>[+ 517 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=grn-inference)</sub>

## Regulatory variant effect

*Assessing the impact of sequence variants on binding and regulatory activity.*

<sub>[137 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=regulatory-variants)</sub>

## Molecular QTL

*eQTL, caQTL and related mapping of variants to regulatory phenotypes.*

<sub>[107 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=molecular-qtl)</sub>
...
<sub>[+ 574 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=nucleosome-chromatin)</sub>

## Histone modifications

*Histone marks, super-enhancers and chromatin-state segmentation from histone data.*

<sub>[54 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=histone-marks)</sub>

## 3D genome & chromatin interactions

*Hi-C, HiChIP and ChIA-PET; loops, TADs, compartments and enhancer-promoter contacts.*

<sub>[224 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=chromatin-3d)</sub>

## DNA methylation

*Methylation calling, differential methylation and methylome resources.*

<sub>[393 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=dna-methylation)</sub>
...
<sub>[+ 228 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=single-cell)</sub>

## Comparative & evolutionary

*Cross-species conservation and evolution of regulatory sequence.*

<sub>[50 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=comparative)</sub>
