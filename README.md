...
- [Motif scanning & enrichment](#motif-scanning--enrichment), 171 tools
...
- [Peak calling](#peak-calling), 500 tools
- [Peak annotation & differential binding](#peak-annotation--differential-binding), 111 tools
- [ChIP/ATAC data resources](#chipatac-data-resources), 116 tools
- [Gene regulatory networks](#gene-regulatory-networks), 416 tools
- [Regulatory variant effect](#regulatory-variant-effect), 108 tools
- [Molecular QTL](#molecular-qtl), 20 tools
- [Nucleosome & chromatin state](#nucleosome--chromatin-state), 354 tools
- [Histone modifications](#histone-modifications), 38 tools
- [3D genome & chromatin interactions](#3d-genome--chromatin-interactions), 95 tools
- [DNA methylation](#dna-methylation), 109 tools
- [Single-cell regulatory genomics](#single-cell-regulatory-genomics), 149 tools
...
<sub>[+ 166 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-scanning)</sub>
...
<sub>[+ 38 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=footprinting)</sub>
...
<sub>[+ 496 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-calling)</sub>

## Peak annotation & differential binding

*Annotating peaks to genes/features and testing differential occupancy.*

<sub>[111 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-annotation)</sub>
...
<sub>[+ 113 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=chip-resources)</sub>
...
<sub>[+ 414 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=grn-inference)</sub>
...
<sub>[20 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=molecular-qtl)</sub>
...
<sub>[+ 353 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=nucleosome-chromatin)</sub>

## Histone modifications

*Histone marks, super-enhancers and chromatin-state segmentation from histone data.*

<sub>[38 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=histone-marks)</sub>

## 3D genome & chromatin interactions

*Hi-C, HiChIP and ChIA-PET; loops, TADs, compartments and enhancer-promoter contacts.*

<sub>[95 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=chromatin-3d)</sub>

## DNA methylation

*Methylation calling, differential methylation and methylome resources.*

<sub>[109 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=dna-methylation)</sub>
...
<sub>[+ 147 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=single-cell)</sub>
...
<sub>[+ 33 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=comparative)</sub>
...
- **1211 (65%) have a website of their own**, meaning a project page, web server or database front end that is not just their source repository. The rest live on a code host alone. The catalog site shows this as a sortable *Site* column, so "web-only resource" and "code, no documentation site" are both answerable questions.
