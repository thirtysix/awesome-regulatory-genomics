...
- [Motif discovery](#motif-discovery), 169 tools
- [Motif scanning & enrichment](#motif-scanning--enrichment), 174 tools
- [Motif comparison & visualisation](#motif-comparison--visualisation), 29 tools
- [Motif & TF databases](#motif--tf-databases), 106 tools
- [TFBS prediction](#tfbs-prediction), 626 tools
- [Promoter & enhancer prediction](#promoter--enhancer-prediction), 480 tools
- [Reporter assays](#reporter-assays), 4 tools
- [Footprinting](#footprinting), 41 tools
- [Peak calling](#peak-calling), 520 tools
- [Peak annotation & differential binding](#peak-annotation--differential-binding), 110 tools
- [ChIP/ATAC data resources](#chipatac-data-resources), 132 tools
- [Gene regulatory networks](#gene-regulatory-networks), 414 tools
- [Regulatory variant effect](#regulatory-variant-effect), 109 tools
- [Molecular QTL](#molecular-qtl), 71 tools
- [Nucleosome & chromatin state](#nucleosome--chromatin-state), 553 tools
- [Histone modifications](#histone-modifications), 39 tools
- [3D genome & chromatin interactions](#3d-genome--chromatin-interactions), 153 tools
- [DNA methylation](#dna-methylation), 316 tools
- [Single-cell regulatory genomics](#single-cell-regulatory-genomics), 168 tools
- [Comparative & evolutionary](#comparative--evolutionary), 34 tools
...
<sub>[+ 164 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-discovery)</sub>
...
<sub>[+ 169 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-scanning)</sub>
...
<sub>[+ 28 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-comparison)</sub>
...
<sub>[+ 100 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-databases)</sub>
...
<sub>[+ 617 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=tfbs-prediction)</sub>
...
<sub>[+ 476 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=regulatory-elements)</sub>
...
<sub>[+ 39 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=footprinting)</sub>
...
<sub>[+ 516 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-calling)</sub>

## Peak annotation & differential binding

*Annotating peaks to genes/features and testing differential occupancy.*

<sub>[110 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-annotation)</sub>
...
<sub>[+ 129 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=chip-resources)</sub>
...
<sub>[+ 412 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=grn-inference)</sub>

## Regulatory variant effect

*Assessing the impact of sequence variants on binding and regulatory activity.*

<sub>[109 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=regulatory-variants)</sub>

## Molecular QTL

*eQTL, caQTL and related mapping of variants to regulatory phenotypes.*

<sub>[71 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=molecular-qtl)</sub>
...
<sub>[+ 552 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=nucleosome-chromatin)</sub>

## Histone modifications

*Histone marks, super-enhancers and chromatin-state segmentation from histone data.*

<sub>[39 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=histone-marks)</sub>

## 3D genome & chromatin interactions

*Hi-C, HiChIP and ChIA-PET; loops, TADs, compartments and enhancer-promoter contacts.*

<sub>[153 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=chromatin-3d)</sub>

## DNA methylation

*Methylation calling, differential methylation and methylome resources.*

<sub>[316 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=dna-methylation)</sub>
...
<sub>[+ 166 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=single-cell)</sub>

## Comparative & evolutionary

*Cross-species conservation and evolution of regulatory sequence.*

<sub>[34 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=comparative)</sub>
...
- **1891 have a publication year**, recovered from OpenAlex where the registry did not record one.
