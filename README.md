...
- [Motif discovery](#motif-discovery), 254 tools
- [Motif scanning & enrichment](#motif-scanning--enrichment), 218 tools
- [Motif comparison & visualisation](#motif-comparison--visualisation), 51 tools
- [Motif & TF databases](#motif--tf-databases), 114 tools
- [TFBS prediction](#tfbs-prediction), 673 tools
- [Promoter & enhancer prediction](#promoter--enhancer-prediction), 560 tools
- [Reporter assays](#reporter-assays), 13 tools
- [Footprinting](#footprinting), 58 tools
- [Peak calling](#peak-calling), 579 tools
- [Peak annotation & differential binding](#peak-annotation--differential-binding), 138 tools
- [ChIP/ATAC data resources](#chipatac-data-resources), 153 tools
- [Gene regulatory networks](#gene-regulatory-networks), 540 tools
- [Regulatory variant effect](#regulatory-variant-effect), 147 tools
- [Molecular QTL](#molecular-qtl), 131 tools
- [Nucleosome & chromatin state](#nucleosome--chromatin-state), 619 tools
- [Histone modifications](#histone-modifications), 56 tools
- [3D genome & chromatin interactions](#3d-genome--chromatin-interactions), 252 tools
- [DNA methylation](#dna-methylation), 450 tools
- [Single-cell regulatory genomics](#single-cell-regulatory-genomics), 243 tools
...
<sub>[+ 249 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-discovery)</sub>
...
<sub>[+ 213 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-scanning)</sub>
...
<sub>[+ 50 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-comparison)</sub>
...
<sub>[+ 664 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=tfbs-prediction)</sub>
...
<sub>[+ 556 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=regulatory-elements)</sub>

## Reporter assays

*MPRA, STARR-seq and other massively parallel tests of regulatory activity.*

<sub>[13 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=reporter-assays)</sub>
...
<sub>[+ 56 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=footprinting)</sub>
...
<sub>[+ 575 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-calling)</sub>

## Peak annotation & differential binding

*Annotating peaks to genes/features and testing differential occupancy.*

<sub>[138 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-annotation)</sub>
...
<sub>[+ 150 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=chip-resources)</sub>
...
<sub>[+ 538 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=grn-inference)</sub>

## Regulatory variant effect

*Assessing the impact of sequence variants on binding and regulatory activity.*

<sub>[147 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=regulatory-variants)</sub>

## Molecular QTL

*eQTL, caQTL and related mapping of variants to regulatory phenotypes.*

<sub>[131 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=molecular-qtl)</sub>
...
<sub>[+ 618 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=nucleosome-chromatin)</sub>

## Histone modifications

*Histone marks, super-enhancers and chromatin-state segmentation from histone data.*

<sub>[56 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=histone-marks)</sub>

## 3D genome & chromatin interactions

*Hi-C, HiChIP and ChIA-PET; loops, TADs, compartments and enhancer-promoter contacts.*

<sub>[252 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=chromatin-3d)</sub>

## DNA methylation

*Methylation calling, differential methylation and methylome resources.*

<sub>[450 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=dna-methylation)</sub>
...
<sub>[+ 241 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=single-cell)</sub>
...
- **2058 have a publication year**, recovered from OpenAlex where the registry did not record one.
