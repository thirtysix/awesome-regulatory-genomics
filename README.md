...
- [Motif discovery](#motif-discovery), 156 tools
...
- [Promoter & enhancer prediction](#promoter--enhancer-prediction), 464 tools
- [Reporter assays](#reporter-assays), 4 tools
- [Footprinting](#footprinting), 39 tools
- [Peak calling](#peak-calling), 493 tools
- [Peak annotation & differential binding](#peak-annotation--differential-binding), 103 tools
- [ChIP/ATAC data resources](#chipatac-data-resources), 113 tools
- [Gene regulatory networks](#gene-regulatory-networks), 401 tools
...
- [Histone modifications](#histone-modifications), 35 tools
- [3D genome & chromatin interactions](#3d-genome--chromatin-interactions), 92 tools
- [DNA methylation](#dna-methylation), 108 tools
...
<sub>[+ 151 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=motif-discovery)</sub>
...
<sub>[+ 460 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=regulatory-elements)</sub>
...
<sub>[+ 489 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-calling)</sub>

## Peak annotation & differential binding

*Annotating peaks to genes/features and testing differential occupancy.*

<sub>[103 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=peak-annotation)</sub>
...
<sub>[+ 399 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=grn-inference)</sub>
...
<sub>[+ 345 more in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=nucleosome-chromatin)</sub>

## Histone modifications

*Histone marks, super-enhancers and chromatin-state segmentation from histone data.*

<sub>[35 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=histone-marks)</sub>

## 3D genome & chromatin interactions

*Hi-C, HiChIP and ChIA-PET; loops, TADs, compartments and enhancer-promoter contacts.*

<sub>[92 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=chromatin-3d)</sub>

## DNA methylation

*Methylation calling, differential methylation and methylome resources.*

<sub>[108 tools in this category →](https://thirtysix.github.io/awesome-regulatory-genomics/?category=dna-methylation)</sub>
...
- **1197 (66%) have a website of their own**, meaning a project page, web server or database front end that is not just their source repository. The rest live on a code host alone. The catalog site shows this as a sortable *Site* column, so "web-only resource" and "code, no documentation site" are both answerable questions.
